...
userSchema.methods.generateAccessToken = function (): string {
  ...
  return jwt.sign(payload, securityConfig.jwt.accessTokenSecret, {
    expiresIn: securityConfig.jwt.accessTokenExpiry as string,
  });
};
...
userSchema.methods.generateRefreshToken = function (): string {
  ...
  return jwt.sign(payload, securityConfig.jwt.refreshTokenSecret, {
    expiresIn: securityConfig.jwt.refreshTokenExpiry as string,
  });
};
...
userSchema.pre(/^find/, function (next) {
  // Type guard to check if this is a Query
  if ('getQuery' in this && 'where' in this) {
